...
<script type="text/javascript" src="<?php echo getServerName();?>assets/js/edit.js"></script>
...
<div class="btn-group">
  	<button id="buttonAddMyLocation" type="button" class="btn btn-primary btn-lg">Add My Location</button>
  	<button id="buttonAddPinnedLocation" type="button" class="btn btn-primary btn-lg">Add Pinned Location</button>
  	<button type="button" class="btn btn-primary btn-lg">Start</button>
  	<button id="buttonShowPOIs" type="button" class="btn btn-success btn-lg">Show POIs</button>
</div>
<!-- THE MAP -->
...
<div id="routePanel">
	<div class="row">
	  ...
	  <div class="col-md-1">
	  		<button id="buttonSearch" type="button" class="btn btn-default">Search</button>
	  </div>
	</div>
	<div class="row">
...
<div id="poiList" class="panel list-group">
	...
	<div id="poiListContainer">
		<!-- SAMPLE OF THE ITEM ADDED DYNAMICALLY IN THE LIST -->
		<!--  <div class="list-group-item">
			<label class="poi-title">Vestibulum at eros</label>
			<button class="btn btn-default list-down">Down</button>
			<button class="btn btn-default list-up">Up</button>
		</div>-->
	</div>
